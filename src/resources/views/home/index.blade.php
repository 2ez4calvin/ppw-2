...
@section('conteudo')
    ...
    <div class="d-flex justify-content-center">
        <div id="carouselExample" class="carousel slide col-md-10">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('imagens/placeholder.png') }}" class="d-block w-100"
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 column-gap-3">
            <div class="card">
                <img src="{{ asset('imagens/placeholder.png') }}" class="w-100 object-fit-cover" style="height: 160px;"
                    alt="...">
                <div class="p-3">
                    <p class="mb-1">Ator</p>
