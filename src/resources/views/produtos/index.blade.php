...
@section('conteudo')
    ...
    <div class='row g-3'>
                ...
                <div class='card h-100 shadow-sm'>
                    ...
                    <div class='card-footer d-flex flex-column'>
                        <form action="/produtos/{{ $produto->id }}" method="POST">
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modal-{{ $produto->id}}"
                        ...
                        <div class="modal fade" id="modal-{{ $produto->id }}" tabindex="-1"
                            aria-labelledby="modal-{{ $produto->id}}" aria-hidden="true">
        ...
        @endforelse
        <h3>Mostrando {{$quantidade_produtos}} produto(s)</h3>
    </div>
@endsection
